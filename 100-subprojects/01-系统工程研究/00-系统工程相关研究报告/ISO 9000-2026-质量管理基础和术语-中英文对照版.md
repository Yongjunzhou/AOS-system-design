...
>
> **④ 本译本作「相关方」，与本仓库报告侧作「利益相关方」并不冲突**。中国国家标准对这两个词形取了两个中文名：**GB/T 19000 译「相关方」**（本译本从之，因为它是 ISO 9000 的译本），**GB/T 22032（ISO/IEC/IEEE 15288）与 GB/T 45630-2025（42010）译「利益相关方」**。本仓库的统一口径因此是：**引 ISO 9000／9001 原文处作「相关方」，自撰正文（尤其架构描述语境，含 42010 的「利益相关方角度」）作「利益相关方」**。
>
> **⑤ 两个词形同概念，不等于两份标准的定义相同**。ISO 9000 的 interested party 取「**能影响**某项决策或活动、**受其影响**，或**自认为受其影响**」——**影响轴**；ISO/IEC/IEEE 15288 的 stakeholder 取「对系统拥有**权利、份额、主张或利益**，或其特性需满足其**需要与期望**」——**权利—主张轴**。中文分译两名的实据在这两处**定义之别**上，不在英文词上（英文是同一概念的两种词形）。
