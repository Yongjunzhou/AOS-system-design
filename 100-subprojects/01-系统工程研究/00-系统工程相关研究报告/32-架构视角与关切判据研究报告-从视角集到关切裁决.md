...
> **文档版本**：v1.1（创建于 2026-09-23；同日并入附录 C 全链示例，原独立附件稿两份退役）→ **v1.2（2026-09-24 依库内标准正本核改条款号：声明目的在 §6.1、关切定义在 42020 §3.8、process purpose 属 15288 §3.29；术语位「生命周期／相关方／视点」按定译表切换）**
> **修订记录（2026-09-24 依库内五份标准正本核改；版本 v1.1 → v1.2）**：五份标准全文入库，本报告涉标准条款号与逐字引文的部分**逐条对正本复核**。**三处条款号错更正**——① **42010:2022 要求声明预期目的的条款是 §6.1**（*An AD shall include a statement of its intended purpose.*），**不是 §5.4**（§5.4 是 *Architecture description frameworks and languages*），且原引英文 *the purposes for which the architecture description is being created* 在库内**全文零命中**——**未核清单第 2 条据此结清**；② **关切定义的出处是 42020:2019 §3.8**（*matter of **interest** or importance to a stakeholder*），**不是 §3.10**（42020 §3.10 是 `library`），且该条**只有 EXAMPLE、无 Note 1**；**两册措辞不同且不可互替**——42010:2022 §3.10 作 *matter of **relevance** or importance*，本报告所引系 42020 措辞；③ **`process purpose` 的逐字属 15288:2023 §3.29**，**不是 42020 §3.29**（42020 条款 3 止于 §3.26 work product，**无 §3.29**）。**术语迁移**：自撰正文「生命周期」改「**生存周期**」、「相关方」改「**利益相关方**」、「视点」改「**架构视角**」。**另核无误**（保留）：§4.1 条款结构表其余各行、§4.4 §8.1＋附录 B、§4.5 八步依据栏、§5.1 42030 摘要 a)–i) 逐字、§5.3 42030 §1 NOTE 逐字、§5.4 三层条款号与附录 D 具名方法、§6.1 42020 §6.4.3／§6.4.4／§8.4.4 逐字与号。**依据**：`90-治理登记/02-标准条款号核对表.md` §三之二与 §五 G-12／G-13／G-14。
...
|---|---|---|---|---|
| **ISO/IEC/IEEE 42010:2022**（＋ GB/T 45630-2025 等同采用） | 2022-11 第 2 版；国标 2025-04-25 发布、2025-11-01 实施 | 架构描述的**结构、表达与符合性**；视角与模型种类的规格要求 | §4 符合性；**§6.1 标识与概览（含预期目的声明）**；§6 架构描述的规格；§6.10 决策与理据的记录；**§7.1 ADF 规格**；**§8.1 视角规格**；**附录 B 视角规格指南** | 要求**声明**预期目的的条款是 **§6.1**（逐字：*An AD shall include a statement of its intended purpose.*；同节另两条：AD 应标识所关注实体及其预期环境、应含标识信息与补充信息）〔2026-09-24 依库内正本更正：原记「只在 §5.4 要求声明目的（*"the purposes for which the architecture description is being created"*），未核」——**该英文句在库内 42010:2022 全文零命中**，§5.4 实为 *Architecture description frameworks and languages*；「未核」撤销〕 |
...
- **process purpose**（过程目的）：过程本身的属性；**15288:2023 §3.29** 逐字 *"high level objective of performing the process and the likely outcomes of effective implementation of the process"* → 实施该过程的**高层级目标**，以及有效实施该过程可能产生的结果。〔2026-09-24 依库内正本更正：该逐字属 **15288:2023 §3.29**；**原挂 42020 §3.29 系误**——42020:2019 条款 3 止于 **§3.26 work product**，**无 §3.29**。〕
...
| 关切定义② | *"matter of interest or importance to a stakeholder"* | 对相关方而言具有**利害或重要性的事项** | **42020:2019 §3.8**〔2026-09-24 依库内正本更正：**原记 §3.10 系误**——42020 §3.10 是 `library`，关切是 **§3.8**。**且两册措辞不同、不可互替**：42020 作 *matter of **interest** or importance to a stakeholder*；**42010:2022 §3.10** 作 *matter of **relevance** or importance to a stakeholder*——本行所引系 **42020** 措辞，正是本报告要对照的「两种表述」〕 |
| 影响来源 | 见 §6.4 表 | — | 42020:2019 **§3.8**〔2026-09-24 更正：**该条只有 EXAMPLE、无 Note 1**，原挂「§3.10 Note 1」两处皆误〕 |
...
| 2 | ~~42010:2022 §5.4「声明目的」条款正文~~ | **✅ 已结清（2026-09-24）**——**条款是 §6.1**，逐字 *An AD shall include a statement of its intended purpose.*；原挂 §5.4 与所引英文句 *the purposes for which the architecture description is being created* 在库内 42010:2022 全文**零命中** |
...
| intended purpose | 目的（预期目的） | **process purpose**（过程目的，**15288:2023 §3.29**）——中文都会写成「目的」〔2026-09-24 更正：原记 42020 §3.29，而 42020 条款 3 止于 §3.26〕 |
...
| 版本 | 日期 | 变更说明 |
|---|---|---|
| **v1.2** | **2026-09-24** | **依库内五份标准正本核改条款号与术语**：① 声明预期目的 → **42010:2022 §6.1**（原记 §5.4，且原引英文句 *the purposes for which the architecture description is being created* 在正本零命中）——未核清单第 2 条据此结清；② 关切定义 → **42020:2019 §3.8**（原记 §3.10，而 §3.10 是 `library`），并注明两册措辞不同（42020 用 *interest*／42010 §3.10 用 *relevance*）、该条**无 Note 1**；③ `process purpose` → **15288:2023 §3.29**（原记 42020 §3.29，而 42020 条款 3 止于 §3.26）；④ 自撰正文术语迁移：生命周期→**生存周期**、相关方→**利益相关方**、视点→**架构视角**。**保留项**（经正本复核无误）：42030 §1 a)–i) 与 §1 NOTE 逐字、42020 §6.4.3／§6.4.4／§8.4.4 逐字与号、附录 D 具名方法 |
