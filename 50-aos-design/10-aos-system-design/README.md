...
**两层产品关系**（产品B是工具、产品A是目标系统）、**三层工作层面**（自指设计 → 交付物构建 → 使用工具设计目标系统）和**自指关系**（产品B是产品A经营管理子系统的一部分）是同一客观事实的三个互补视角。

| 视角 | 焦点 | 说明 |
|------|------|------|
| **两层产品关系**（静态） | "谁是什么" | 产品B是设计工具，产品A是被设计的系统 |
| **三层工作层面**（动态） | "谁在做什么" | 团队B负责第1层自指设计和第2层交付物构建，团队A负责第3层系统设计 |
| **自指关系**（递归） | "谁包含谁" | 产品B是产品A经营管理子系统的组成部分——系统包含设计自身的规则 |

> **推论**：开发产品B所用的准则、规范、流程自然地适用于开发整个运营体系，因为运营体系的设计本身就是运营体系的经营管理活动之一。
