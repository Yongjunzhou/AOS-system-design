...
核心认知：
- **来源**：本目录文档基于产品B的AI辅助文档模板（位于 `10-pipeline-design/.../03-pipeline-system-design-ai-support/04-devops-pipeline-system-design/`）定制，属于**结构复用、内容定制**（复用 DevOps 3种模式/4步流程的文档结构，内容面向 AOS 领域）
