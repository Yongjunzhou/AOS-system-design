...
**第一部分（§零~§六）**：继承原设计准则
- EOS 流水线的产品语境和特有设计框架（三层工作层面、pa-eng 节点定义原则、信息处理模式）
- 通用方法论精要（摘要引用自通用设计规范）
- **§四 各层设计指引**：流水线特有场景化指导（OR/业务概要/业务详细/系统功能概要/产品概要 各层实例）
- EOS 流水线验收标准和常见错误
...
### 07-pl4eos-spec-sr-refactor-summary-2026-06-16.md
**BA→SR / `wft03` 重构变更摘要**

- 说明本轮 `BA→SR` 口径统一的背景、结论和影响
- 归纳通用规范与 EOS 流水线规范的同步调整点
- 用于团队快速理解：为什么 `wft03` 不再独立去重、为什么 `05` 要改成交互文档、为什么非末级与末级节点要分开定义口径
