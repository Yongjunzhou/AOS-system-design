...
本目录包含 EOS 企业运营体系的 9 份标准产品数据文档（01~09），按系统设计准则五层结构组织。另有 6 份跨层资产文档：21~23 为发现型资产，24~25 为定义型资产，27 为资源资产清单。24 号可复用业务资产、25 号引擎资产（含业务文档承接 §1.7）和 27 号资源资产清单与 23 号输出产品架构台账共同构成完整的输出产品架构资产体系（26 号文档资产已取消，2026-08-22）。
...
|------|---------|---------|---------|------|
| 01 | [规范化需求清单](01-eos-specified-requirements.md) | 第 1 层 | 第 1 步 | 结构已改造，现有 规范化需求 已迁入索引 |
