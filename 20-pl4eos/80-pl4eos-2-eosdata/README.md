...
本目录包含 EOS 企业运营体系的 9 份标准产品数据文档（01~09），按系统设计准则五层结构组织。另有 7 份跨层资产文档：21~23 为发现型资产，24~25 为定义型资产，26 为文档资产清单，27 为资源资产清单。24 号可复用业务资产、25 号引擎资产、26 号文档资产清单和 27 号资源资产清单与 23 号输出产品架构台账共同构成完整的输出产品架构资产体系。
...
| 25 | [引擎资产](25-eos-engine-models.md) | 跨层（定义型资产·wft02 写回目标） | wft02 | 结构已改造，待填充 |
