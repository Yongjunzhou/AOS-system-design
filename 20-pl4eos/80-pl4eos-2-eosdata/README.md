...
本目录包含 EOS 企业运营体系的 9 份标准产品数据文档（01~09），按系统设计准则五层结构组织。另有 5 份跨层资产文档：21~22 为发现型资产，24~25 为定义型资产，27 为资源资产清单。24 号可复用业务资产、25 号引擎资产（含业务文档承接 §1.7）和 27 号资源资产清单共同构成输出产品资产体系（23 号输出产品架构资产已取消，2026-09-21——P 树即资产，其资产对齐的引用数据在 P 树上取；26 号文档资产已取消，2026-08-22）。
...
> **说明**：01~09 为 EOS 标准设计产出，首轮已完成可按需读取的结构改造，正文仍待后续系统设计迭代填充。21~27 为跨层资产文档，其中 22 保留了既有资产内容，其他资产文档以结构和写回模板为主，待后续实例化。
