...
| 方向 | Skill | 交接内容 |
|------|-------|---------|
| 上游 | `wft01-eng` | 产出 STR-E（主责能力域、能力链、概要末级节点、详细需求条目、CU 承接关系、依赖STR-E）。通过 `## AI可以处理节点` 的"待 wft02-eng 处理"分节检测 |
...
4. **定义 CU 配置能力**——承接 wft01 分组结构，逐配置信息组定义内容：

| 定义项 | 回答的问题 | 设计粒度 |
|------|------------|---------|
| 配置信息组 | 该组配置字段共同提供什么可以运行的能力 | 承接 wft01 分组，逐组定义配置操作/系统处理/运行期能力 |
