...
description: bpd-eng(A1)→srh-eng·系统需求概要。承接配置信息组操作活动定义，组织五类功能表单+概要说明（页面职责/类别/使用角色/承载关系/操作活动清单/页面编排概要），布局组件/构件与pa-eng收敛项下移wft04-eng，推进bpd-eng→已srh设计，srh-eng→可以详细定义。
---
