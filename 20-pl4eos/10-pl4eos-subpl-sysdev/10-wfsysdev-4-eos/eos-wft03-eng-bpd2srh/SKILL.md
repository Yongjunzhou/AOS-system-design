...
> **设计依据**：[eos-wft03-eng-bpd2srh.md](../eos-wft03-eng-bpd2srh.md)（SKILL 指南——权威源）
...
**锁定写回**：输入校验通过后，将承接的 bpd-eng 状态写为 `在srh设计`（锁定态，本 Skill 消费展开期间，对齐 SKILL 指南 §4.1 与 91 §A.6 锁定态=下游写入）；完成系统需求概要且人类确认后推进 `已srh设计`。
