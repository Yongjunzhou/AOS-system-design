...
>
> **版本**：v5.18 | **修订**：2026-08-18 | **说明**：NFR 定量指标来源链级联动（对齐 ort02 v0.27 / ort03 v0.45 / 通用设计规范 §1.2 需求=需求描述+性能指标）——§九 wft01-nfr 任务2 改「记录相关方已确认的目标值」、wft04-nfr 定位/量化指标六要素/任务2 改「承接经澄清确认的目标值，展开统计口径/测量方法/验收条件」
