...
>
> **版本**：v5.7 | **修订**：2026-07-28 | **说明**：§11 增补表单式节点表示——§11.4 新增统一 13 字段横表表单（全层级通用）与六级层级模型（业务域→项目类型→端到端业务→WBS→输出文档→构件，L5=输出文档、旧版 IPO 弃用）；§11.3 说明表单式与块式等价；§11.9 新增定义点/引用点判定（R13a/R13b）与原创追溯链。配合 23 号资产 v3.0 表单化重构
