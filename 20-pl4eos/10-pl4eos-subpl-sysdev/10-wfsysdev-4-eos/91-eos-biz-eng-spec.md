...
>
> **版本**：v5.5 | **修订**：2026-07-13 | **说明**：可读性修订——长句拆分、段落拆分、术语加粗、过渡引导优化。§9.2 任务 7 闭环检查项 `biz-eng一致` → `eng一致`（NFR 约束仅流向 eng 路径，无 biz 端消费）
...
以上七种页面类型中，前五种（窗口标签页、全屏单据页、辅助栏标签页、弹窗页面）由功能引擎配置生成，后两种为编排容器或硬代码页面。以下进一步解释页面组件、功能表单和交互规则。
