...
>
> **版本**：v3.16 | **修订**：2026-07-08 | **说明**：NFR 路径实例化补全——§8.1.0 增补 wft01-nfr / wft04-nfr 入口条件；§8.5 增补 NFR 反馈实例化参数；§8.6 增补 NFR 状态名映射；§8.8 增补 NFR 路径实例化总表。与 wft01-nfr v3.1、wft04-nfr v3.1 同步。
