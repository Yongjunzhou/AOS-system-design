...
>
> **版本**：v5.6 | **修订**：2026-07-14 | **说明**：§1.1.1 页面类型定义重构——窗口标签页从"四种显示页面并列"改为"三种可切换模式（列表/单据/图示→指标/看板）"；指标页面和看板页面从独立显示页面改为图示模式的具体形态，补充滚动行为；单据模式补充上下翻页；常规数据增加指标模式（功能表单指标定义）；§1.1.2/§4.1/§4.2 级联更新；@engine-indicator `图示模式` → `指标图示模式` 以与页面层区分
