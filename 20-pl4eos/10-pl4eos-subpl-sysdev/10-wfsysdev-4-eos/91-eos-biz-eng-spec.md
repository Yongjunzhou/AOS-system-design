...
>
> **版本**：v4.8 | **修订**：2026-07-11 | **说明**：§七~§九 全章重构（产出物链清晰化 + 双表合一 + NFR→eng 单向流 + 平台服务组件）+ 附录A 重构为四部分结构 + §10.4/§10.6 参数对齐 + §十一 新增产品文档结构、读写及反馈（AI可以处理节点、子条目状态、变更感知、HEAD 追踪）+ 附录A 读取/写回协议全量同步 + 全文缺陷修复。
