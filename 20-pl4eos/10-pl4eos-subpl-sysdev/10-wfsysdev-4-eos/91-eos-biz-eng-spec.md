...
>
> **版本**：v5.8 | **修订**：2026-08-10 | **说明**：§11 与 23 号资产符合性修复——§11.4 表单式字段集「输入/输出」分拆为「输入」「输出」两列（12→13 列，对齐 23 号资产 v3.0 实际字段集）；§11.3 增补「业务域节点」可选小节与 R2a；§11.6 补充非 Skill 触发变更的「操作 Skill」列填写规则（`文档重构`）与全文档变更时的超链接处理
