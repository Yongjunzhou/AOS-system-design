...
>
> **版本**：v5.21 | **修订**：2026-08-20 | **说明**：反馈检出位置对齐 §11.10（Step Start）——§A.5 反馈通道 + §A.5.4 确认状态字段两处「经 Step 1 变更感知 git diff 检出」→「经 Step Start 变更感知（git diff，§11.10）检出」，消除规范内部矛盾（§11.10 权威口径为 Step Start）；链级推广 wft01-eng v8.9 / wft02-eng v9.1 / wft02-biz v9.0 同款修复
