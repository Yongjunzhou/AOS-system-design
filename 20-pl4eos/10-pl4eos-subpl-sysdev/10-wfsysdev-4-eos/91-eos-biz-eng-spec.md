...
>
> **版本**：v4.5 | **修订**：2026-07-11 | **说明**：§九 新增 NFR 路径独立章节（原 §九→§十）——对齐 biz（§七）/eng（§八）结构，补充 wft01-nfr 和 wft04-nfr 的定位/输入/产出/任务清单完整定义。§十（原 §九）三路径体系编号同步更新。§10.6 eng 参数表补全资产写回行与空白字段；§7.1 Task 3 描述拆分；§7.3 关键澄清提升为正文。
