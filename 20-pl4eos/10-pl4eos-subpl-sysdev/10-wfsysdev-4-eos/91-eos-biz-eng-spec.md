...
>
> **版本**：v5.9 | **修订**：2026-08-11 | **说明**：设计链层术语修正——"业务架构（BA）"→"业务流程（BP）"，对齐架构基础概念与方法 v3.0 第五章设计链定义（OR → STR → BP → SR → PA）。涉及：设计链层缩写 BA→BP、BA节点/方案→BP节点/方案、业务架构方案→业务流程方案、业务架构开发→业务流程开发、产品业务架构→产品业务流程、配置单元BA→配置单元BP、节点ID前缀@ba-→@bp-、Skill引用名wft02/03-biz/eng-str2ba/ba2sr→str2bp/bp2sr、04文档描述、类型示例BA.L5→BP.L5。保留"业务架构管理员"角色名不变
