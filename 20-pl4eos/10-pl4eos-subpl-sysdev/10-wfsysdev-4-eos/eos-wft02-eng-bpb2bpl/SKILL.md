...
| 定义项 | 回答的问题 | 设计粒度 |
|------|------------|---------|
| 配置信息组 | 该组配置字段共同提供什么可以运行的能力 | 承接 wft01 的配置信息组清单+结构判定级框架说明，逐组展开操作活动定义（配置操作步骤序列/系统处理[编辑时+生效后]/运行期能力分支显式化） |
...
5. **输出页面推导线索**——为每个 CU 记录配置角色、入口职责、配置对象、活动顺序和运行支撑需求，交由 wft03-eng 组织系统需求框架（功能表单）；不形成页面设计结论
...
| 定义项 | 回答的问题 | 设计粒度 |
|------|------------|---------|
| 配置信息组 | 该组配置字段共同提供什么可以运行的能力 | 承接 wft01 的配置信息组清单+结构判定级框架说明，逐组展开操作活动定义（配置操作步骤序列/系统处理/运行期能力） |
