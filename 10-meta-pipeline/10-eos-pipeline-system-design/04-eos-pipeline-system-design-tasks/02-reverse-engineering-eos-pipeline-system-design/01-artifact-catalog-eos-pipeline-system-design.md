...
**对应 AI 模板**：`03-eos-pipeline-system-design-ai-support/02-reverse-engineering-eos-pipeline-system-design/workflow-prompts.md` 第1步
**对应设计指南**：[逆向工程系统设计指南 第1步](../../02-eos-pipeline-system-design-guidelines/02-reverse-engineering-eos-pipeline-system-design-guide.md#第1步现有产物梳理与架构分析)
...
|------|------|
| 项目目录结构 | 整个仓库根目录 |
| 现有设计文档 | `01-eos-pipeline-system-design-specification/` |
| 现有设计指南 | `02-eos-pipeline-system-design-guidelines/` |
| 现有 AI 辅助文档 | `03-eos-pipeline-system-design-ai-support/` |
| 现有产品数据模板 | `10-eos-pipeline-system-product-data/` |
| 通用方法论 | `00-general/` |
...
详见 `03-eos-pipeline-system-design-ai-support/02-reverse-engineering-eos-pipeline-system-design/workflow-prompts.md` 第1步"现有产物梳理与架构分析"。
