...
产出的文稿体例与 `50-subprojects/05-投资工程研究/00-投资工程研究报告/` 下的既有材料一致：元信息表＋说明注＋目录＋第一部分要点摘要（一句话主旨／时间轴／核心观点／术语校正清单／值得记住的一段）＋第二部分完整逐字稿。
...
以 `50-subprojects/05-投资工程研究/00-投资工程研究报告/01-张小珺商业访谈录153-和曾鸣聊产业史观.md` 那一期（154 分钟）为样本：
