...
**对应 AI 模板**：`30-eos-system-design-ai-support/01-waterfall-eos-system-design/workflow-prompts.md` 第2步
...
| 文件 | 说明 |
|------|------|
| 相关方需求详细定义子文档 | `90-eos-system-product-data/03-stakeholder-requirements-detailed.md` |
