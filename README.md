...
AOS 是企业运营体系（Enterprise Operation System）的简称。本仓库包含通用方法论基础（`00-general/`）、产品B（系统设计流水线）和产品A（AOS企业运营体系）的开发空间，共用同一套设计准则和方法论，通过 AI 辅助实现流程自动化。

### 产品关系核心认知

运营体系（AOS）涵盖市场、研发、生产、售后、**经营管理**等活动。系统设计流水线（产品B）本质上属于经营管理职能——它是管理"运营体系如何持续设计和优化"的方法和工具。因此，**产品B是产品A经营管理子系统下的一个特殊构件**。

这一关系意味着：开发产品B所用的准则、规范、流程**自然地适用于开发整个运营体系**——因为运营体系的设计本身就是运营体系的经营管理活动之一。

### 产品类型决定 PA 形态

产品A和产品B遵循同一套方法论，但 PA 产物形态不同——原因不在于方法论，而在于产品类型和消费方式不同：

| 维度 | 产品B（流水线） | 产品A（运营体系） |
|------|---------------|-----------------|
| 产品类型 | 方法论/知识工具 | 企业管理信息系统 |
| PA 构件的本质 | 知识制品（准则、指南、AI辅助、任务定义） | 软件构件（前端、后端、数据、基础设施） |
| 用户 | AOS 开发者（人 + AI） | 企业员工 |
...
| 层面 | 内容 | 负责方 | 仓库位置 |
|------|------|--------|---------|
| **第1层：自指设计** | 团队B用五层结构对产品B本身进行系统设计，产出产品B的产品架构 | 团队B | `10-pipeline-design/` |
| **第2层：交付物构建** | 基于同构性，将产品B的设计产物适配为产品A的设计工具集（准则、指南、AI辅助、任务定义） | 团队B | `50-aos-design/10-aos-system-design/{01,02,03,04}-*` |
| **第3层：使用工具设计产品A** | 团队A使用第2层产出的工具，对运营体系进行系统设计，产出产品A的产品架构 | 团队A | `50-aos-design/10-aos-system-design/10-aos-system-product-data/` |

**两个产品**：
- **产品B — 系统设计流水线**：产品A经营管理子系统下的知识工具型构件
- **产品A — AOS 企业运营体系**：企业实际运行所依赖的 IT/AI 化运营系统
...
| 场景 | 适用情况 | 周期 | 指南 |
|------|---------|------|------|
| 瀑布式 | 全新系统，需求明确 | 30-48天 | `02-pipeline-system-design-guidelines/01-waterfall-pipeline-system-design-guide.md` |
| 敏捷式 | 迭代开发，需求渐进 | 13-21天 | `02-pipeline-system-design-guidelines/03-agile-pipeline-system-design-guide.md` |
| 逆向工程 | 已有系统补文档 | 16-26天 | `02-pipeline-system-design-guidelines/02-reverse-engineering-pipeline-system-design-guide.md` |
| DevOps | 小变更快速交付 | 几小时-3天 | `02-pipeline-system-design-guidelines/04-devops-pipeline-system-design-guide.md` |
