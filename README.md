...
| 如果你想 | 请阅读 |
|---------|--------|
| 理解方法论核心（五层结构、核心规则、六步法 + 四种设计模式） | [`00-generalspec/10-general-sysdev-standards/01-general-sysdev-spec.md`](00-generalspec/10-general-sysdev-standards/01-general-sysdev-spec.md) |
...
三条核心规则：**1:1 分配约束**、**N:1 承接支持**、**双向追溯**。详见[通用设计规范](00-generalspec/10-general-sysdev-standards/01-general-sysdev-spec.md)。
