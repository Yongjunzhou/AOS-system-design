...
AOS 是企业运营体系（Enterprise Operation System）的简称。本仓库包含通用方法论基础（`00-general-standards/`）和两个系统设计项目，共用同一套设计准则和方法论，通过 AI 辅助实现流程自动化。
...
│   │   ├── 01-pipeline-system-design-standards.md  #   核心：5层结构、映射规则、流水线六步法
│   │   ├── 02 ~ 06                                 #   各层设计规范（OR/SR/BA/SysReq/PA）
│   │   └── 07-pipeline-system-design-terminology-glossary.md  #   术语表
...
| 文件 | 说明 |
|------|------|
| `10-pipeline-design/10-pipeline-system-design/01-pipeline-system-design-standards/01-pipeline-system-design-standards.md` | 核心设计准则（5层结构、映射规则、术语定义） |
