...
每个产品的工作空间按产品开发三阶段组织：`10-*-sysdev/`（阶段1：系统设计）、`20-*-comdev/`（阶段2：构件开发，待扩展）、`30-*-integration-delivery/`（阶段3：集成交付，待扩展）。此外，`30-eos/` 为 EOS 产品本体，按四条流水线的产出组织为五个子目录。
...
| 如果你想 | 请阅读 |
|---------|--------|
| 理解方法论核心（五层结构、核心规则、六步法 + 四种设计模式） | [`00-generalspec/01-general-sysdev-spec.md`](00-generalspec/01-general-sysdev-spec.md) |
...
三条核心规则：**1:1 分配约束**、**N:1 承接支持**、**双向追溯**。详见[通用设计规范](00-generalspec/01-general-sysdev-spec.md)。
