...
**2026-08-17 已解决**：wft03a/wft03b 旧 a-b 对模型已废弃（归档 `90-hold/legacy-a-b-pairs/`），现行模型是 `eos-wft03-biz-bpd2sfh.md` / `eos-wft03-eng-bp2sr.md`。已把 92-srf 三处引用改现行文件（概述"wft03a/wft03b"→"wft03-biz/wft03-eng"、设计模式参考、§六 关系表），版本 v1.0→v1.1。
