...
|---------|------|------|
| 组件级 | 场景引擎 | L4 场景业务 |
| 部件级 | 表单引擎、流程引擎、看板引擎、工单引擎 | L5 场景部件 |
| 元件级 | 实体引擎 | L6 功能元件 |
...
| eos-wft01-biz-spr2bpb.md | — | 场景定义→场景业务，功能菜单→场景部件，菜单级→场景部件级 |
...
### 已完成
- 全量术语标准化（17 文件）
- wft01-biz-spr2bpb v1.27 Step 3 场景部件架构锚点修正——去菜单引擎残留
...
- eos-wft01-biz-spr2bpb: v1.27（待改 §3.1/§3.2）
