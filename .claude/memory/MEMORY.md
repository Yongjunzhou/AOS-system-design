...
- [ort 可读性审视模式](ort-review-style-pattern.md) — 2026-08-17：ort01 趟出并应用（ort01 v0.53/v2.35 样板；ort00 v0.30/v2.5；ort02 v0.22/v2.7；ort03 v0.39/v2.7 四轮），同链推广完成；2026-08-18 ort02 逐章彻底修订（v0.33/v2.18，六种子类型+NFR 目标值澄清+全文一致性）+ ort01 以 ort02 对齐并补 Step End（v0.57/v2.39，F1 闭环）；核心方法论前置 §二 已对齐（ort01/02/03）；Step 框架 ort01/02/03 统一八步 Start/1-6/End、ort00 简化
