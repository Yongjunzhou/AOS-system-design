...
- [wft05-eng 深审已落地（2026-08-25）](wft05-eng-deep-review.md) — 主 v10.11/SKILL v2.4 + 链级 wft04 v2.1/v1.10 + 91 v5.42：**C1 标题正名**「系统需求详细定义 → 平台产品架构」（人类定名）+ M1（§2.4.1 四级→五级）+ M2（九项→十项 2 处）+ M3（BP→bpd-eng 2 处）+ M4（删 §5.1.2 重复行）+ S1~S4（SKILL 十项/FR-BIZ 冻结条/删重复行/05→06）+ **C2 srd-eng 文件位置 05→06 链级**（wft04 同款 + 91 §10.6 写回列 06/25·06/07/23/25；输入侧 srh-eng 05 保留；设计层级号 04/05 不动）；挂账：**正文「产品概要定义」vs 标题「平台产品架构」对齐未做（链级术语改名待决）** + 正式 OR 节点改名链级清扫
