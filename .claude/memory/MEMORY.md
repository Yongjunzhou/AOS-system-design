- [wft01-biz 审视发现与运行模型定案](wft01-biz-review-ort02-benchmark.md) — 2026-08-19：以 ort02 为标杆可读性审视三轮全落地（v3.4/v1.1 C1+C2；v3.5/v1.2 S1 自检清单+C3 引擎术语+D1 SKILL 概念+叙述层；v3.6/v1.3 第二章三步设计地图）；剩 O2 跳版 + 链级术语统一待办
