- [wft01-biz 审视发现与运行模型定案](wft01-biz-review-ort02-benchmark.md) — 2026-08-19：以 ort02 为标杆可读性审视，两轮落地（v3.4/v1.1 C1+C2 反馈口径+提交基线；v3.5/v1.2 S1 自检清单+C3 引擎术语+D1 SKILL 概念+叙述层）；剩 S2 章节拆分/O2 跳版 + 链级术语统一待办
