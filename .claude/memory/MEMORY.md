...
- [94 号＝全链树权威（2026-09-10）](94-eos-sys-dev-dbs-tree-authority.md) — v1.18：两章 + 树名矩阵 + 三个依据；§2.2 四节序 Rn／Pn／R0／P0（P0 收五级、R0 少「角色职责」）；全文去 PL／SL 层码与枝梢叶标注；变更记录整节删除；**§2.4 平台构成勿自行改**（人类退回）；含 10 条仍开着的分叉与待裁
...
- [人类方案六章布局改造 · 93规范（2026-09-04）](eos-design-landing-spec-93-refactor.md) — 以 20 号落地方法改造 EOS 设计线人类方案：新六章骨架（目的与目标/输入文档结构及规则/输出文档结构及规则/输出与输入转换规则/转换流程及检验规则/资产文档结构及规则）+ 三条原则（概念跟文档走/schema 全链单源/边界文档 A.ch3 生产侧=B.ch2 消费侧接口契约）；93-eos-skill-guide-spec.md 升 v0.4 + biz 三试点（eos-biz01/02/03）v0.9-pilot 成稿→批次1/2 审改已提交（试点 v0.11-pilot / 93 v0.5 / 91 v5.53·§5.3.1 判据之家）；批次3 02 打样待铺（下午开工点见记忆）
