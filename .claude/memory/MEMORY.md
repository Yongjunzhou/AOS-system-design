...
- [ort02/03 逐章可读性修订计划](ort02-03-readability-revision-plan.md) — 2026-08-17：计划新开对话逐章修订 ort02/ort03 提升人类可读性（每次一章），样板 ort01 v0.53 可读性审视模式；ort02 §一~§五 + 全文一致性修复已完成（2026-08-18，v0.33/v2.18：规则前置重排+六种子类型+NFR 目标值澄清+各章精简+术语统一），当前 ort03 v0.45/v2.13
...
- [ort 可读性审视模式](ort-review-style-pattern.md) — 2026-08-17：ort01 趟出并应用（ort01 v0.53/v2.35 样板；ort00 v0.30/v2.5；ort02 v0.22/v2.7；ort03 v0.39/v2.7 四轮），同链推广完成；2026-08-18 ort02 逐章彻底修订（v0.33/v2.18，六种子类型+NFR 目标值澄清+全文一致性）+ ort01 对齐并补 Step End（v0.57/v2.39，F1 闭环）+ ort00 同款对齐（v0.31/v2.6）——链级叙述层全部对齐；核心方法论前置 §二 已对齐（ort01/02/03）；Step 框架 ort01/02/03 统一八步 Start/1-6/End、ort00 简化五步
