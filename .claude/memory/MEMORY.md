...
- [挂账：biz01abr 第五章优化＝下一开工点（2026-09-20）](pending-biz01abr-ch5.md) — 第四章已收口（提交 `68bb04db`，**未推**）；进第五章先看四条：缺口规则该在第四还是第五章、§5.1 的 Step 名体例要不要同落进 93 §3.5、§5.1.3 的伞名与 §4.2 粒度不对齐是**对的**别改、§5.2 关口三组与 §4.3 两表有没有跨章双写。详见文件
