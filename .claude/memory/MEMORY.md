...
- [页面四级模型（2026-09-16）](page-ui-four-levels.md) — 91 v5.62 首次把页面层级与业务流程树对齐：场景标签页↔④／窗口标签页↔⑤／表单标签页↔⑥／功能操作项↔⑦；菜单标签页只是浏览器标签页容器、不占树级
- [biz 链重编号（2026-09-16）](biz-chain-renumbering-2026-09-16.md) — 01a `stfr2rbph`／01b `rbph2pbph`／02 `rbph2rbpd`；R→P 是**同一个任务位的两半**；**P 侧不需要方案**（界面只属 R 侧）；`04` 恢复；biz02 正文待重写
...
- [SKILL 指南编制规范 93 · 试点 biz01（2026-09-04，2026-09-16 第三次更新）](eos-design-landing-spec-93-refactor.md) — 六章骨架 + 三条原则；**93 现第 46 版**——v44 去独立资产文档（第六章更名「关联产品数据及规则」，21~28 全清）、v45 R／P 拆分连带、v46 新增「阶段一可由两个并列任务分担同一份产品数据的两个视角，合占一个任务位，编号同号加字母」；**biz 链重编号 01a／01b／02**，三试点已 `git mv` 改名；**下一会话开工点＝重写 biz02**
