- [ort 可读性审视模式](ort-review-style-pattern.md) — 2026-08-17：ort01 趟出并应用（ort01 v0.52/v2.34 样板；ort00 v0.30/v2.5 已完成，登记簿 F29~F37）；模式清单（章/节一句话、定义单源、术语瘦身、人类参与导航、状态/反馈分块、模板口径、双文档同步），ort02/ort03 待推广
