...
- [wft02-biz 知识层三章重构](wft02-biz-v80-knowledge-layer-restructure.md) — 2026-08-19：以 wft01-biz v3.11 为标杆重构（v7.4→v8.0，完整对标）——§二 改为基本概念（转换总览六步一条链+规则地图）、新 §三 设计原理与判据（3.1 转换原理/3.2 引擎校验/3.3 资产对齐/3.4 PL6-B 判据/3.5 完备性）、新 §四 节点演进（生命周期/变更传播）、操作流程顺延 §五、自检清单 §七；D/PCA「完全同构」→「流程骨架同构」；SKILL 锚点 #262→#332
