...
- [94 号＝全链树权威（2026-09-10）](94-eos-sys-dev-dbs-tree-authority.md) — 94-eos-sys-dev-dbs.md 树形/级语义唯一权威（v1.0 补 §0.3 级语义与承接规则 + §3.1 注「③＝系统职责维度」）；A2↔2.1/Bn↔2.2/A1↔2.3；叶=末级·枝梢=叶上一级·概要=根→枝梢·完整态=根→叶；**92 号已删除退役**；待裁 A1 树↔91 §3.1 + SR 末级⑥IPO功能↔91 功能表单，再改 91
