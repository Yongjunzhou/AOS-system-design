...
- [biz 链深审：四轮完成并提交](pending-biz-chain-deep-review.md) — wft01 v3.22/wft02 v9.8/wft03 v10.4 + SKILL v1.17/v1.15/v1.14 + 25 v2.6 + 24 v1.6 + 91 v5.36；第四轮（wft01 审视，2026-08-24）：A1 wft02 补 `在分解分配` 锁步、A2 跨角色保留硬退出、B 删 wft01-runtime-protocols.md 直引 91、C SKILL v1.17 七项同步、D1 变更记录表拆分补录（v3.21/v9.7/v3.14~16/v9.0~2）；三轮详见文件；挂账：wft03 §5.6 Step 5 真实 BP 可执行性 + 25 CU 待填充随 eng 链消解
