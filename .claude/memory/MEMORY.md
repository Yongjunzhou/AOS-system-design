- [培训教材+教材书项目](concept-book-training-project.md) — 2026-08-19：基于50-reserch八份笔记做两个共享同一架构（9单元=9章）的产出——分组研讨式培训教材（同类分组，单元一样章已产出）+ 独立成书教材书；书定位已定（独立成书/标准当骨架/思想著作/使命=消除误解）；三篇九章结构已定（评审提前至第4章）；议程剩余：贯穿案例/每章模板/改编策略/三者关系/写作顺序
- [wft01-biz 审视发现与运行模型定案](wft01-biz-review-ort02-benchmark.md) — 2026-08-19：以 ort02 为标杆可读性审视七轮全落地（v3.4~v3.10），最终知识层三章（概念/原理与判据/节点演进）+ 链级术语统一 + O2 补录，审视待办清零；C2 提交基线运行模型已定案落地
...
- [ort 可读性审视模式](ort-review-style-pattern.md) — 2026-08-17：ort01 趟出并应用（ort01 v0.53/v2.35 样板；ort00 v0.30/v2.5；ort02 v0.22/v2.7；ort03 v0.39/v2.7 四轮），同链推广完成；2026-08-18 ort02 逐章彻底修订（v0.33/v2.18，六种子类型+NFR 目标值澄清+全文一致性）+ ort01 对齐并补 Step End（v0.57/v2.39，F1 闭环）+ ort00 同款对齐（v0.31/v2.6）——链级叙述层全部对齐；核心方法论前置 §二 已对齐（ort01/02/03）；Step 框架 ort01/02/03 统一八步 Start/1-6/End、ort00 简化五步；2026-08-19 ort00 以 wft01-biz 为标杆知识层三章重构（v0.32/v2.7，概念/原理/演进/操作）+ ort01 同款完成（v0.58/v2.40，转换总览+切分原理+演进章，归属取舍定案；ort03 status 权威引用随迁 §2.3.2）+ ort02 同款完成（v0.35/v2.20，澄清主线+澄清原理+演进章，归属取舍定案；ort03 完整性口径引用随迁 §三 3.2）——链级知识层三章 ort00~02 完成，ort03 收官待续
