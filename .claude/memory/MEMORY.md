...
- [biz 链深审：三轮全部完成并提交](pending-biz-chain-deep-review.md) — wft01 v3.21/wft02 v9.7/wft03 v10.4 + SKILL v1.16/v1.14/v1.14 + 25 v2.6 + 24 v1.6 + 91 v5.36；三轮：C 组六项+取消26扩展25、实锤1覆盖判定纯语义化、第三轮 5 主题 26 项（待填充CU归Q3/消费版本统一到消费者节点/下游列表查询指引/引擎偏好句重写/表单使用顺序归Step3/Q2残留）；挂账：wft03 §5.6 Step 5 真实 BP 可执行性 + 25 CU 待填充随 eng 链消解
