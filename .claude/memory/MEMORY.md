...
- [ort02/03 逐章可读性修订计划](ort02-03-readability-revision-plan.md) — 2026-08-17：计划新开对话逐章修订 ort02/ort03 提升人类可读性（每次一章），样板 ort01 v0.53 可读性审视模式；ort02 §二 已完成（2026-08-18，v0.27/v2.12，三轮：判定要点单源 §3.5+直觉示例+AI 红线表+「什么是模糊」定义小节+缺少定量指标第六子类型），当前 ort03 v0.45/v2.13
