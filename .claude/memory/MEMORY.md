...
- [ort 可读性审视模式](ort-review-style-pattern.md) — 2026-08-17：ort01 趟出并应用（ort01 v0.53/v2.35 样板；ort00 v0.30/v2.5；ort02 v0.22/v2.7；ort03 v0.39/v2.7 四轮），同链推广完成；2026-08-18 ort02 逐章彻底修订（v0.33/v2.18，六种子类型+NFR 目标值澄清+全文一致性）+ ort01 对齐并补 Step End（v0.57/v2.39，F1 闭环）+ ort00 同款对齐（v0.31/v2.6）——链级叙述层全部对齐；核心方法论前置 §二 已对齐（ort01/02/03）；Step 框架 ort01/02/03 统一八步 Start/1-6/End、ort00 简化五步；2026-08-19 ort00 以 wft01-biz 为标杆知识层三章重构（v0.32/v2.7，概念/原理/演进/操作）
- [ort01 待知识层重构](ort01-knowledge-layer-restructure-pending.md) — 2026-08-19 待办：以 ort00 v0.32 为直接标杆优化 ort01（概念/原理/演进/操作）；现状 v0.57/v2.39 已对齐「核心方法论前置 §二」；需先基准对比 + 人类确认归属取舍（状态模型归概念/反馈检测归判据/重进入变更传播归演进）
