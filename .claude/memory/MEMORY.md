- [ort02 澄清问题清单设计](ort02-clarify-question-list.md) — 2026-08-17：AI 标注生成向相关方确认的问句（`[⨯子类型: 原文→问题：…]`），开发者持清单向相关方澄清后写 `[✓已澄清: <相关方确认内容>]`；质量诉求路由识别不量化、转 NFR 路径；三项条件=相关方已确认；ort02 v0.20/v2.5 落地
- [ort 可读性审视模式](ort-review-style-pattern.md) — 2026-08-17：ort01 趟出并应用（ort01 v0.52/v2.34 样板；ort00 v0.30/v2.5 已应用，登记簿 F29~F37；ort02 v0.18/v2.3 已应用，登记簿 F38~F47；ort03 v0.35/v2.3 已应用，登记簿 F-a~F-n，中4/低10）；模式清单（章/节一句话、定义单源、术语瘦身、人类参与导航、状态/反馈分块、模板口径、双文档同步），同链推广完成
