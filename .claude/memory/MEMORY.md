...
- [94 号＝全链树权威（2026-09-16 更新）](94-eos-sys-dev-dbs-tree-authority.md) — **v1.23 定形**：Rn／Pn 末三级＝业务文档⑤→任务节点⑥（枝梢）→用例场景⑦（叶），④＝E2E职责；§2.1.1 X 树＝业务文档①→任务节点②→用例场景③，**X 的 ①②③ 就是 Y 的 ⑤⑥⑦**（同名同批、无映射无承接）；**业务流程这一对两形态合并在一份文档（04 含概要、02 退役）**；**产品数据即资产、R 树与 P 树就是资产**（21／23／25 作废）；名字全部对齐；含 12 条仍开着的分叉
...
- [SKILL 指南编制规范 93 · 试点 biz01（2026-09-04，2026-09-16 更新）](eos-design-landing-spec-93-refactor.md) — 六章骨架 + 三条原则；**93 现第 43 版**；**biz01 第 29 版整篇重写**——文件更名 `eos-biz01-stfr2bp.md`、指南ID `biz01-stfr2bp`、由「承接设计出概要」改为「组装 R 树与 P 树、产出业务流程方案」，七步 Step、覆盖缺口两条通道；含本会话确立的四条方法与仍开着的账
