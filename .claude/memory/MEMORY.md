...
- [94 号＝全链树权威（2026-09-09）](94-eos-sys-dev-dbs-tree-authority.md) — 94-eos-sys-dev-dbs.md 定为树形/级语义唯一权威；A2↔2.1/Bn↔2.2/A1↔2.3；叶=末级·枝梢=叶上一级·概要=根→枝梢·完整态=根→叶；SR功能树六层（信息系统顶）；已改 93 v0.7/92 v1.4；**待裁 94 §2.3 A1 树↔91 §3.1 冲突**（WBS/CU=PL4/配置信息组=PL5），再改 91
