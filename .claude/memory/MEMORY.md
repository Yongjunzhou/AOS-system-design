...
- [定案：第三章成表、第二章收成一节 ＋ 93 的图表达规则（2026-09-18）](ch2-ch3-tabling-2026-09-18.md) — 第三章＝图3-1 ＋ 表3-1 意义 ＋ 表3-2 实现规则 ＋ 表3-3~3-9 各级节点属性（一节点一表）＋ 传出承诺收在 3.3 末；第二章＝图2-1 ＋ 表2-1 意义 ＋ 两条注（表2-2 撤、§2.2 撤、章下无节题）；93 §2.3／§3.2／§3.3 同改，新增「图与表都带编号与标题（章-序）」「树权威不逐图注明」「节点类型判据写进意义表」；提交 `9f6a5f73`＋`fc6a0284`；**未落七项**（abp／cr 未同步为首）
