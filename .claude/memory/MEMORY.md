- [wft01-biz 审视发现与运行模型定案](wft01-biz-review-ort02-benchmark.md) — 2026-08-19：以 ort02 为标杆可读性审视五轮全落地（v3.4~v3.8：C1+C2、S1 自检+D1 SKILL+叙述层、三步地图、拆两章+2.0 转换总览、链级术语统一+O2 补录），审视待办清零；C2 提交基线运行模型已定案落地
