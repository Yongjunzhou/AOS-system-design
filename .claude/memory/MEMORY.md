...
- [biz 链深审全部完成：A1+A2+B（b86266a）+ C 组六项 + 取消 26 扩展 25 + 第二轮实锤 1/2 + 观察 3~6](pending-biz-chain-deep-review.md) — wft01 v3.20/wft02 v9.6/wft03 v10.3 + SKILL v1.15/v1.13/v1.13 + 25 v2.6 + 91 v5.35；**实锤 1 定案：wft03 覆盖判定纯语义化、移除「性能指标上限」（系统性能归 NFR 链 @nfr-001，数值验证在构件开发/测试）；25 §2.0 补功能引擎表单能力表**；C 组六项 + 26 取消（文档定义落 04/05/06 + 25 §1.7；清单条目字段：风险/问题→工单、计划/行动项/改进措施→计划）
