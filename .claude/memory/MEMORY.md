...
- [人类方案六章布局改造 · 93规范（2026-09-04）](eos-design-landing-spec-93-refactor.md) — 以 20 号落地方法改造 EOS 设计线人类方案：新六章骨架（目的与目标/输入文档结构及规则/输出文档结构及规则/输出与输入转换规则/转换流程及检验规则/资产文档结构及规则）+ 三条原则（概念跟文档走/schema 全链单源/边界文档 A.ch3 生产侧=B.ch2 消费侧接口契约）；新文件 93-eos-sysdev-landing-spec.md v0.1（设计与开发落地方案编制规范）；wft01-biz 试写验证中
