...
- [待办：深入审视 eng 链（重点关注业务链）](pending-eng-chain-deep-review.md) — wft01-eng v9.6/wft02-eng v10.1/wft03-eng v9.1/wft04-eng v1.1/wft05-eng v10.1 + SKILL v1.11/v1.10/v1.5/v1.1/v1.4；聚焦 eng↔biz 衔接（FR-ENG 线索回路/FR-BIZ 指标约束包/CU 设计权/biz↔eng 对称/并行路径）；复用 biz 深审方法（锚点/资产结构/SKILL 一致性）
- [eng 链 5 层「概要/详细」框架（定案，①~⑥步全部完成）](eng-chain-five-layer-framework.md) — 01 业务概要[配置信息组+概要说明·结构判定级]/02 业务详细[操作活动定义·基准=PDF v1.5.2]/03 功能概要[功能表单+概要说明]/04 功能详细[新增 wft04-eng]/05 产品概要[前后端组件]；逻辑同构 biz、内容异质；02 详设基准=Downloads PDF v1.5.2（**.md 旧形态保存时处理不作基准**）；实施：①wft01-eng v9.5（aab2f53）②wft02-eng v10.0（d0a0f46）③wft03-eng v9.0（82abf4f）④新增 wft04-eng v1.0（18338de）⑤wft05-eng v10.0（71ef6b7）⑥91 规范 v5.27 + 锚点联动（04d99d6）；SKILL：wft01 v1.11/wft02 v1.10/wft03 v1.5/wft04 v1.0/wft05 v1.4；03/04 同写 SR-F 状态机接力（`可以详细定义`→`已详细定义`）
