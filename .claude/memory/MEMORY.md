...
- [94 号＝全链树权威（2026-09-10）](94-eos-sys-dev-dbs-tree-authority.md) — 94-eos-sys-dev-dbs.md 树形/级语义唯一权威（**v1.8，全文两章**：一「产品数据及其形态」＝§1.1 EOS 的产品数据清单（01/02·04/05·06/07，六·七待定义）／**§1.2 三个前提（为什么可以条目化 / 可以树形化 / 可以 N:1 分配）**／§1.3 两个形态+叶的判据／§1.4 承接+反误读注；二「各产品数据的分解结构」＝§2.1 相关方需求／§2.2 业务流程（A2·Bn·A1）／§2.3 系统需求／§2.4 平台构成／§2.5 配置方案／§2.6 前后端组件方案；**94 只给结论+依据名称，完整论证在 95**）；叶=末级·枝梢=叶上一级·概要=根→枝梢·完整态=根→叶；**92 号已删除退役**；已裁 SR 末级（91 v5.54 枝梢⑤/叶⑥，§10.3/§10.4 残留待清）；**待裁 A1 树↔91 §3.1** + 07/§2.4 平台构成口径；外引联动 91 v5.56 / 93 v0.10 / 05 v3.9 / 01-pl4eos-spec v2.2（未提交）
- [分类视角 vs 页面视角（2026-09-10）](page-view-vs-classification-view-correspondence.md) — 两视角正交（③类单归属 / 功能表单多归属）；功能表单↔A2/Bn **⑥任务节点**步骤、**配置信息组↔功能表单的配置信息组区**；SR 树**枝梢＝⑤ 用例场景功能 / 叶＝⑥ IPO功能**（只在完整态）；功能表单**不属于** SR 树；91 已改 v5.54 十一处；未决 A1 是否有 ⑦ 用例场景类操作层
