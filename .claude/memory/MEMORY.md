...
- [eng 链第三轮深审已完成（b7ee9e9），剩余待办 B2 ort 适配 + B4 约束包载体](pending-eng-chain-deep-review.md) — 第三轮修复：A 级（wft05 FR-BIZ 幽灵输入四项全做/约束包行组成/不负责 #3 路由/越界设计分支/biz 术语污染）；B 级（候选线索落盘/字段集引用式/缺口行锚点放宽/清除条件补齐+91 §A.5.4 强制/锚点契约对齐）；术语读法 A（「概要末级节点」取消→「业务概要定义末级节点」=配置信息组）；版本 91 v5.32/wft01 v9.8·v1.13/wft02 v10.4·v1.12/wft03 v9.3·v1.8/wft04 v1.4/wft05 v10.4·v1.7/biz03 v10.0·v1.10/25 v2.4/26 v1.1/28 v1.3；下一轮建议：biz↔eng 对称性语义深挖 + 清除条件复检 + 术语落地复检 + 约束包载体定案后三端同步
