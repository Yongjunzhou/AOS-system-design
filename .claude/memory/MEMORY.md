...
- [biz 链深审：两轮完成 + 第三轮开工点已登记](pending-biz-chain-deep-review.md) — wft01 v3.20/wft02 v9.6/wft03 v10.3 + SKILL v1.15/v1.13/v1.13 + 25 v2.6 + 91 v5.35；两轮：C 组六项+取消26扩展25（文档定义落04/05/06+25§1.7）、实锤1覆盖判定纯语义化（25§2.0功能引擎表单能力、系统性能归NFR链）；**第三轮开工点**：覆盖判定CU前向引用/D-PCA一致性/追溯链/菜单编排/Q2残留——新会话接续
