...
- [biz 链深审全部完成：A1+A2+B（b86266a）+ C 组六项 + 取消 26 扩展 25](pending-biz-chain-deep-review.md) — wft01 v3.20/wft02 v9.6/wft03 v10.2 + SKILL v1.15/v1.13/v1.12 + 25 v2.5 + 91 v5.34；**架构决策：26 号文档资产取消**（归档 90-hold，文档定义落 04/05/06 + 25 §1.7 业务文档承接；清单条目字段：风险/问题→工单、计划/行动项/改进措施→计划）；C 组六项全落（24 口径 L0~L6/末级=功能表单/不负责补24/引擎候选校验目标/归纳枝分工注/Step 3 引用）
