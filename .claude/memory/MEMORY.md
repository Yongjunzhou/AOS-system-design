...
- [ort03 逐章可读性修订计划](ort02-03-readability-revision-plan.md) — 2026-08-18：ort02 已彻底修订（v0.33/v2.18）+ 链级对齐（ort01 v0.57 / ort00 v0.31）完成，打法已趟通（章首导航/规则前置/反馈机制一句话/自检清单分组/全文一致性通读）；下一目标 ort03 逐章修订（当前 v0.45/v2.13）
