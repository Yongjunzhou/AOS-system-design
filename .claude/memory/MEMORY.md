...
- [wft02-biz 知识层重构与审视修复](wft02-biz-v80-knowledge-layer-restructure.md) — 2026-08-19：以 wft01-biz 为标杆知识层重构（v7.4→v8.0）+ 审视修复（v8.1）+ STR→BP 原理讨论（v8.2~v8.4：任务类型-引擎耦合/引擎权威定位/双视角互证修正互为投影/语言层级施工图比喻）+ 任务活动设计补齐（v8.5：§5.5.3 覆盖计划/流程/工单三类）；SKILL 锚点 #262→#332
