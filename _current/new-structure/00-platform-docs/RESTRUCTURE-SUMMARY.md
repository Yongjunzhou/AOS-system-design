...
02-sr-ba-design/          ← Task 2：SR → BA映射
03-ba-sysreq-design/      ← Task 3：BA → SysReq映射
04-sr-nfr-design/         ← Task 4：SR-NFR → SysReq-NFR映射
05-sysreq-pa-design/      ← Task 5：SysReq → PA映射
06-traceability-analysis/ ← Task 6：端到端符合性分析
...
- **映射关系**：SysReq → PA（N:1）
- **目录**：`05-sysreq-pa-design/`

### Task 6：端到端符合性分析
- **输入**：所有设计文档
- **输出**：追溯矩阵 + 符合性报告 + 缺陷清单
- **关键活动**：追溯分析、符合性检查、缺陷识别
- **目录**：`06-traceability-analysis/`
...
│   └── examples/                  # 示例
│
├── 02-sr-ba-design/          # Task 2
├── 03-ba-sysreq-design/      # Task 3
├── 04-sr-nfr-design/         # Task 4
├── 05-sysreq-pa-design/      # Task 5
├── 06-traceability-analysis/ # Task 6
│
├── 07-shared-assets/              # 跨任务共享资产
│   ├── patterns/
...
| **Task 1 README** | `01-normalization/README.md` | Task 1快速开始 |
| **Task 2 README** | `02-sr-ba-design/README.md` | Task 2快速开始 |
| **Task 3 README** | `03-ba-sysreq-design/README.md` | Task 3快速开始 |
| **Task 4 README** | `04-sr-nfr-design/README.md` | Task 4快速开始 |
| **Task 5 README** | `05-sysreq-pa-design/README.md` | Task 5快速开始 |
| **Task 6 README** | `06-traceability-analysis/README.md` | Task 6快速开始 |
