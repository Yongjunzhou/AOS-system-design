...
| 概念 | 仓库目录 | 说明 |
|------|---------|------|
| 通用方法论 | `00-general-standards/` | 与具体产品无关的通用准则、指南、术语（所有产品参考） |
...
**产品同构性与内容参考**：产品B和产品A共用同一套五层结构和设计方法论。通用方法论核心位于 [`00-general-standards/`](00-general-standards/)，各产品在此基础上参考适配：

| AOS 子目录 | 参考来源 | 策略 |
|-----------|---------|------|
| `01-aos-system-design-standards/` | `00-general-standards/01-general-design-standards.md` + `10-pipeline-design/.../01-pipeline-system-design-standards/` | 通用方法论参考通用准则，流水线示例参考 Pipeline |
| `02-aos-system-design-guidelines/` | `00-general-standards/02-general-design-guide-overview.md` + `10-pipeline-design/.../02-pipeline-system-design-guidelines/` | 通用方法框架参考通用指南，示例参考 Pipeline |
| `03-aos-system-design-ai-support/` | `10-pipeline-design/.../03-pipeline-system-design-ai-support/` | 结构参考，内容需定制（场景不同） |
| `06-aos-system-design-tasks/` | 流水线的 6 个核心任务定义 | 结构参考，内容需定制（操作对象不同） |
...
```
00-general-standards/                            # 通用方法论基础（产品无关）
├── 01-general-design-standards.md               # 通用设计准则（五层结构、核心规则、术语）
├── 02-general-design-guide-overview.md          # 通用设计指南（四种方法框架）
...
> 通用方法框架参见 [`00-general-standards/02-general-design-guide-overview.md`](00-general-standards/02-general-design-guide-overview.md)

| 场景 | 适用情况 | 周期 | Pipeline 指南 |
|------|---------|------|-------------|
| 瀑布式 | 全新系统，需求明确 | 30-48天 | `10-pipeline-design/.../02-pipeline-system-design-guidelines/01-pipeline-system-waterfall-design-guide.md` |
| 敏捷式 | 迭代开发，需求渐进 | 13-21天 | `10-pipeline-design/.../02-pipeline-system-design-guidelines/02-pipeline-system-agile-design-guide.md` |
| 逆向工程 | 已有系统补文档 | 16-26天 | `10-pipeline-design/.../02-pipeline-system-design-guidelines/03-pipeline-system-reverse-engineering-guide.md` |
| DevOps | 小变更快速交付 | 几小时-3天 | `10-pipeline-design/.../02-pipeline-system-design-guidelines/04-pipeline-system-devops-design-guide.md` |
...
- `00-general-standards/01-general-design-standards.md` — 通用设计准则（方法论核心）
- `00-general-standards/02-general-design-guide-overview.md` — 通用设计指南（方法框架）
- `00-general-standards/04-general-terminology-glossary.md` — 通用术语对照
- `10-pipeline-design/10-pipeline-system-design/01-pipeline-system-design-standards/01-pipeline-system-design-standards.md` — 流水线设计准则（通用方法论 + 流水线专有）
...
两个项目的产品数据（`10-pipeline-system-product-data/` 和 `10-aos-system-product-data/`）都遵循相同结构（模板参考 `00-general-standards/03-specification-template.md`）：
