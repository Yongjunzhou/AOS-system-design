...
**文档版本**：v1.2  
**创建日期**：2026-05-18  
**用途**：统一英文术语，便于国际化和技术交流。本文档服务于产品B（系统设计流水线）的开发和使用。
...
| 流水线开发者 | Pipeline Developer | 开发和维护系统设计流水线的团队成员（产品B开发团队） |
| 运营体系开发者 | AOS Developer | 使用流水线进行企业运营体系系统设计的开发者（产品A设计团队） |
| 企业运营体系 | Enterprise Operation System (AOS) | 流水线的目标设计对象——企业的 IT/AI 化运营系统 |
...
| 中文 | 英文 | 文件名 |
|------|------|--------|
| 系统设计准则总纲 | System Design Standards | 01-system-design-standards.md |
| 原始需求规范 | Original Requirements Specification | 02-original-requirements-specification.md |
| 相关方需求规范 | Stakeholder Requirements Specification | 03-stakeholder-requirements-specification.md |
| 业务架构规范 | Business Architecture Specification | 04-business-architecture-specification.md |
| 系统需求规范 | System Requirements Specification | 05-system-requirements-specification.md |
| 产品架构规范 | Product Architecture Specification | 06-product-architecture-specification.md |
| 术语对照表 | Terminology Glossary | 07-terminology-glossary.md |
| 规范模板 | Specification Template | 00-specification-template.md |
| 瀑布式设计指南 | Waterfall System Design Guide | 01-waterfall-design-guide.md |
| 敏捷式设计指南 | Agile System Design Guide | 02-agile-design-guide.md |
| 逆向工程指南 | Reverse Engineering Guide | 03-reverse-engineering-guide.md |
| DevOps设计指南 | DevOps System Design Guide | 04-devops-design-guide.md |
| 快速参考卡 | Quick Reference Card | 05-quick-reference-card.md |
...
| 2026-05-18 | 修正使用建议中的 AOS 标题和角色示例 | v1.3 |
