...
**决策评审点 CDCP（Concept Decision Checkpoint）**：决定是否进入计划阶段。

### 5.3 计划阶段（Plan）

**核心问题：怎么做？**

概念阶段确定了"做什么"，计划阶段要给出完整的施工方案：
- **PRD**（产品需求文档）：产品到底要做成什么样
- **架构方案**：技术上的总体设计
- **项目计划**：时间、资源、里程碑
...
*图 10｜系统 ≠ 架构 ≠ 架构描述，对应 Frege 的指称 ≠ 涵义 ≠ 符号*
...
*图 12｜ISO 42010 架构描述的三层结构：问题层 → 机制层 → 结果层*
...
*图 15｜4+1 View Model：Scenarios 作为验证其余四个视图一致性的胶水*
