...
**对应 AI 模板**：`03-pipeline-system-design-ai-support/01-pipeline-system-design-waterfall/workflow-prompts.md` 第5步
...
| 文件 | 说明 |
|------|------|
| 系统需求详细定义文档 | `10-pipeline-system-product-data/06-system-requirements-detailed.md` |
