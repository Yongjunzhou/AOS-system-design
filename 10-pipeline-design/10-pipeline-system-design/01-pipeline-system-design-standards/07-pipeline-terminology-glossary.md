...
**文档版本**：v1.2  
**创建日期**：2026-05-18  
**用途**：统一英文术语，便于国际化和技术交流。本文档服务于产品L（系统设计流水线）的开发和使用。
...
| 流水线开发者 | Pipeline Developer | 开发和维护系统设计流水线的团队成员（产品L开发团队） |
| 运营体系开发者 | AOS Developer | 使用流水线进行企业运营体系系统设计的开发者（产品M设计团队） |
...
| 中文 | 英文 | 文件名 |
|------|------|--------|
| 系统设计准则总纲 | System Design Standards | 01-pipeline-design-standards.md |
