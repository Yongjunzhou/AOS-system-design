...
**对应 AI 模板**：`03-pipeline-system-design-ai-support/02-reverse-engineering/workflow-prompts.md` 第1步
...
| 文件 | 说明 |
|------|------|
| 产物总览清单（产物分类 + 架构层级映射） | `04-pipeline-system-design-tasks/01-reverse-engineering/outputs/task-01-artifact-catalog.md` |
